...
<NpmBadge package="@vuepress/core" /><p>插件 API 是由 <a href="https://www.npmjs.com/package/@vuepress/core" target="_blank" rel="noopener noreferrer">@vuepress/core<ExternalLinkIcon/></a> 包支持的。你可以查看 <RouterLink to="/zh/reference/node-api.html">Node API</RouterLink> 来了解如何使用插件 Hooks 中的 VuePress App 实例。</p>
...
<ul>
<li>
<p>类型： <code v-pre>Record&lt;string, any&gt; | ((app: App, isServer: boolean) =&gt; Record&lt;string, any&gt;)</code></p>
</li>
<li>
<p>详情：</p>
<p>定义路径别名。</p>
