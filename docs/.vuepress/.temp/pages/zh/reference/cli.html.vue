...
<NpmBadge package="@vuepress/cli" /><p>VuePress 命令行接口是由 <a href="https://www.npmjs.com/package/@vuepress/cli" target="_blank" rel="noopener noreferrer">@vuepress/cli<ExternalLinkIcon/></a> 包提供的。它包含在 <a href="https://www.npmjs.com/package/vuepress" target="_blank" rel="noopener noreferrer">vuepress<ExternalLinkIcon/></a> 包之中，当然你也可以单独安装它。</p>
