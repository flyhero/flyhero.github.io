...
<NpmBadge package="@vuepress/theme-default" /><h2 id="所有页面" tabindex="-1"><a class="header-anchor" href="#所有页面" aria-hidden="true">#</a> 所有页面</h2>
...
<li>
<p>默认值： <code v-pre>280</code></p>
</li>
<li>
<p>详情：</p>
<p>首页图片 <code v-pre>&lt;img&gt;</code> 标签的 <code v-pre>height</code> 属性。</p>
<p>当你的首页图片高度小于默认值时，你可能需要减小该属性。</p>
<p>需要注意的是，首页图片的高度同样受到了 CSS 的约束。设置这个属性主要是为了减少由加载首页图片引起的 <a href="https://web.dev/cls/" target="_blank" rel="noopener noreferrer">累积布局偏移 (CLS)<ExternalLinkIcon/></a> 。</p>
</li>
</ul>
