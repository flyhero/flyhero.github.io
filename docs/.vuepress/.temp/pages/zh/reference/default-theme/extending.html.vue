...
<p>首先，创建一个客户端配置文件 <code v-pre>.vuepress/client.ts</code> ：</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来，创建 <code v-pre>.vuepress/layouts/Layout.vue</code> ，并使用由默认主题的 <code v-pre>Layout</code> 布局提供的插槽：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时默认的 <code v-pre>Layout</code> 布局已经被你的本地布局覆盖，将会在除了首页外的所有页面添加一个自定义的页脚：</p>
...
<p>默认主题将所有 <a href="https://github.com/vuepress/vuepress-next/tree/main/ecosystem/theme-default/src/client/components" target="_blank" rel="noopener noreferrer">非全局的组件<ExternalLinkIcon/></a> 都注册了一个带 <code v-pre>@theme</code> 前缀的 <RouterLink to="/zh/reference/plugin-api.html#alias">alias</RouterLink> 。例如，<code v-pre>HomeFooter.vue</code> 的别名是 <code v-pre>@theme/HomeFooter.vue</code> 。</p>
<p>接下来，如果你想要替换 <code v-pre>HomeFooter.vue</code> 组件，只需要在配置文件 <code v-pre>.vuepress/config.ts</code> 中覆盖这个别名即可：</p>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token function">defineUserConfig</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="开发一个子主题" tabindex="-1"><a class="header-anchor" href="#开发一个子主题" aria-hidden="true">#</a> 开发一个子主题</h2>
<p>除了在 <code v-pre>.vuepress/config.ts</code> 和 <code v-pre>.vuepress/client.ts</code> 中直接扩展默认主题以外，你可以通过继承默认主题来开发一个你自己的主题：</p>
