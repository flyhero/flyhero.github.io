...
<NpmBadge package="@vuepress/plugin-docsearch" /><p>将 <a href="https://docsearch.algolia.com/" target="_blank" rel="noopener noreferrer">Algolia DocSearch<ExternalLinkIcon/></a> 集成到 VuePress 中，为你的文档网站提供搜索功能。</p>
...
<li>
<p>默认值： <RouterLink to="/zh/reference/config.html#base">base</RouterLink></p>
</li>
<li>
<p>详情：</p>
<p>搜索索引基础路径。</p>
...
<p>如果你不同部署域名下的 <RouterLink to="/zh/reference/config.html#base">base</RouterLink> 是不一样的，你就需要将这个配置设置成 <em>索引域名</em> 的 <RouterLink to="/zh/reference/config.html#base">base</RouterLink> ，这样其他的部署域名就可以正确复用索引了。</p>
</li>
</ul>
