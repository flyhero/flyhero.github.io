...
<p>此外，一些符号如 <code v-pre>:</code> 和 <code v-pre>+</code> 可能对 vue-router 有特殊含义，因此你应该避免使用它们，请参阅 <a href="https://router.vuejs.org/zh/guide/essentials/route-matching-syntax.html" target="_blank" rel="noopener noreferrer">vue-router 文档<ExternalLinkIcon/></a> 了解更多详情。</p>
</div>
...
<div class="custom-container tip"><p class="custom-container-title">提示</p>
<p>前往 <RouterLink to="/zh/reference/frontmatter.html">Frontmatter 参考</RouterLink> 查看 VuePress 支持的 Frontmatter 配置。</p>
