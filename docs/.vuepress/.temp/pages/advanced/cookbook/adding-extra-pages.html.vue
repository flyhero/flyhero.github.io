<template><div><h1 id="adding-extra-pages" tabindex="-1"><a class="header-anchor" href="#adding-extra-pages" aria-hidden="true">#</a> Adding Extra Pages</h1>
<p>Sometimes you might want to add some extra pages without creating a markdown file in the source directory.</p>
<p>With the help of <RouterLink to="/reference/plugin-api.html">Plugin API</RouterLink> and <RouterLink to="/reference/node-api.html">Node API</RouterLink>, we can do that with ease.</p>
<h2 id="add-a-default-homepage" tabindex="-1"><a class="header-anchor" href="#add-a-default-homepage" aria-hidden="true">#</a> Add a Default Homepage</h2>
<p>As a theme author, you may not require users to create a <code v-pre>/README.md</code> file as the homepage, but you want to provide a default one:</p>
