<template><div><h1 id="plugin-api" tabindex="-1"><a class="header-anchor" href="#plugin-api" aria-hidden="true">#</a> Plugin API</h1>
<NpmBadge package="@vuepress/core" /><p>Plugin API is supported by <a href="https://www.npmjs.com/package/@vuepress/core" target="_blank" rel="noopener noreferrer">@vuepress/core<ExternalLinkIcon/></a> package. You could check out <RouterLink to="/reference/node-api.html">Node API</RouterLink> for how to use the VuePress app instance in plugin hooks.</p>
...
<blockquote>
<p>Check out <RouterLink to="/advanced/architecture.html#core-process-and-hooks">Advanced &gt; Architecture &gt; Core Process and Hooks</RouterLink> to understand the process better.</p>
</blockquote>
<h2 id="basic-options" tabindex="-1"><a class="header-anchor" href="#basic-options" aria-hidden="true">#</a> Basic Options</h2>
...
<p>If set to <code v-pre>false</code>, when using plugins with the same name, the one used previously will be replaced by the one used later.</p>
<p>If set to <code v-pre>true</code>, plugins with the same name could be used multiple times and won't be replaced.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<h2 id="development-hooks" tabindex="-1"><a class="header-anchor" href="#development-hooks" aria-hidden="true">#</a> Development Hooks</h2>
<h3 id="alias" tabindex="-1"><a class="header-anchor" href="#alias" aria-hidden="true">#</a> alias</h3>
<ul>
<li>
<p>Type: <code v-pre>Record&lt;string, any&gt; | ((app: App, isServer: boolean) =&gt; Record&lt;string, any&gt;)</code></p>
</li>
<li>
<p>Details:</p>
...
<ul>
<li>
<p>Type: <code v-pre>string | ((app: App) =&gt; string | Promise&lt;string&gt;)</code></p>
</li>
<li>
<p>Details:</p>
<p>Path of client config file.</p>
<p>This hook accepts an absolute file path, or a function that returns the path.</p>
</li>
<li>
<p>Example:</p>
</li>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  clientConfigFile<span class="token operator">:</span> path<span class="token punctuation">.</span><span class="token function">resolve</span><span class="token punctuation">(</span>
...
<li>Also see:
<ul>
<li><RouterLink to="/reference/client-api.html#defineclientconfig">Client API &gt; defineClientConfig</RouterLink></li>
<li><RouterLink to="/advanced/cookbook/usage-of-client-config.html">Advanced &gt; Cookbook &gt; Usage of Client Config</RouterLink></li>
</ul>
</li>
</ul>
...
<p>This hook accepts an object or a function that returns an object.</p>
<p>This can be useful for passing variables to client files. Note that the values will be automatically processed by <code v-pre>JSON.stringify()</code>.</p>
</li>
<li>
<p>Example:</p>
</li>
...
<ul>
<li>
<p>Type: <code v-pre>(options: BundlerOptions, app: App) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
<p>Bundler options extension.</p>
<p>This hook accepts a function that will receive the bundler options.</p>
<p>This hook can be used for modifying bundler options.</p>
<p>You could determine which bundler the user is using by <code v-pre>app.options.bundler.name</code>.</p>
</li>
<li>
<p>Example:</p>
</li>
</ul>
<p>Adding default <a href="https://vuejs.org/api/application.html#app-config-compileroptions" target="_blank" rel="noopener noreferrer">app.compilerOptions.isCustomElement<ExternalLinkIcon/></a> option:</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<ul>
<li>
<p>Type: <code v-pre>(options: MarkdownOptions, app: App) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
<p>Markdown options extension.</p>
<p>This hook accepts a function that will receive the markdown options.</p>
...
<li>Also see:
<ul>
<li><RouterLink to="/reference/config.html#markdown">Config &gt; markdown</RouterLink></li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>Type: <code v-pre>(md: Markdown, app: App) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
<p>Markdown enhancement.</p>
<p>This hook accepts a function that will receive an instance of <code v-pre>Markdown</code> powered by <a href="https://github.com/markdown-it/markdown-it" target="_blank" rel="noopener noreferrer">markdown-it<ExternalLinkIcon/></a> in its arguments.</p>
<p>This hook can be used for using extra markdown-it plugins and implementing customizations.</p>
</li>
<li>
<p>Example:</p>
</li>
...
<ul>
<li>
<p>Type: <code v-pre>(options: PageOptions, app: App) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
<p>Page options extension.</p>
<p>This hook accepts a function that will receive the options of <code v-pre>createPage</code>.</p>
...
<p>Set permalink pattern for pages in <code v-pre>_posts</code> directory:</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<ul>
<li>
<p>Type: <code v-pre>(page: Page, app: App) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
<p>Page extension.</p>
<p>This hook accepts a function that will receive a <code v-pre>Page</code> instance.</p>
<p>This hook can be used for adding extra properties or modifying current properties on <code v-pre>Page</code> object.</p>
<p>Notice that changes to <code v-pre>page.data</code> and <code v-pre>page.routeMeta</code> can be used in client side code.</p>
</li>
<li>
<p>Example:</p>
</li>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>In client component:</p>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> usePageData <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/client'</span>
...
<li><RouterLink to="/reference/node-api.html#data">Node API &gt; Page Properties &gt; data</RouterLink></li>
<li><RouterLink to="/reference/node-api.html#routemeta">Node API &gt; Page Properties &gt; routeMeta</RouterLink></li>
</ul>
</li>
</ul>
<h2 id="lifecycle-hooks" tabindex="-1"><a class="header-anchor" href="#lifecycle-hooks" aria-hidden="true">#</a> Lifecycle Hooks</h2>
<h3 id="oninitialized" tabindex="-1"><a class="header-anchor" href="#oninitialized" aria-hidden="true">#</a> onInitialized</h3>
<ul>
<li>
<p>Type: <code v-pre>(app: App) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
...
<ul>
<li>
<p>Type: <code v-pre>(app: App, watchers: Closable[], restart: () =&gt; Promise&lt;void&gt;) =&gt; void | Promise&lt;void&gt;</code></p>
</li>
<li>
<p>Details:</p>
<p>This hook will be invoked once VuePress app has started dev-server and watched files change.</p>
<p>The <code v-pre>watchers</code> is an array of file watchers. When changing config file, the dev command will be restarted and those watchers will be closed. If you are adding new watchers in this hook, you should push your watchers to the <code v-pre>watchers</code> array, so that they can be closed correctly when restarting.</p>
<p>The <code v-pre>restart</code> is a method to restart the dev command. When calling this method, the <code v-pre>watchers</code> array will be closed automatically.</p>
</li>
</ul>
