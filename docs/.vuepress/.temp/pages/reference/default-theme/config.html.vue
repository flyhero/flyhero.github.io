...
<NpmBadge package="@vuepress/theme-default" /><div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defaultTheme <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/theme-default'</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  theme<span class="token operator">:</span> <span class="token function">defaultTheme</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    <span class="token comment">// set config here</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="basic-config" tabindex="-1"><a class="header-anchor" href="#basic-config" aria-hidden="true">#</a> Basic Config</h2>
<h3 id="locales" tabindex="-1"><a class="header-anchor" href="#locales" aria-hidden="true">#</a> locales</h3>
<ul>
<li>
<p>Type: <code v-pre>{ [path: string]: Partial&lt;DefaultThemeLocaleData&gt; }</code></p>
</li>
<li>
...
<p>This option will only take effect in default theme, so don't confuse with <code v-pre>locales</code> in <RouterLink to="/reference/config.html#locales">Site Config</RouterLink>.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<h2 id="locale-config" tabindex="-1"><a class="header-anchor" href="#locale-config" aria-hidden="true">#</a> Locale Config</h2>
...
<ul>
<li>
<p>Type: <code v-pre>'auto' | 'light' | 'dark'</code></p>
</li>
<li>
<p>Default: <code v-pre>'auto'</code></p>
</li>
<li>
<p>Details:</p>
<p>Default color mode.</p>
<p>If set to <code v-pre>'auto'</code>, the initial color mode will be automatically set according to <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme" target="_blank" rel="noopener noreferrer">prefers-color-scheme<ExternalLinkIcon/></a>.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<p>If set to <code v-pre>true</code>, a button to switch color mode will be displayed in the navbar.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><a href="#colormode">Default Theme &gt; Config &gt; colorMode</a></li>
<li><a href="#togglecolormode">Default Theme &gt; Config &gt; toggleColorMode</a></li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>Type: <code v-pre>false | (NavbarItem | NavbarGroup | string)[]</code></p>
</li>
<li>
<p>Default: <code v-pre>[]</code></p>
</li>
...
<p>Set to <code v-pre>false</code> to disable navbar.</p>
<p>To configure the navbar items, you can set it to a <em>navbar array</em>, each item of which could be a <code v-pre>NavbarItem</code> object, a <code v-pre>NavbarGroup</code> object, or a string:</p>
<ul>
<li>A <code v-pre>NavbarItem</code> object should have a <code v-pre>text</code> field and a <code v-pre>link</code> field, could have an optional <code v-pre>activeMatch</code> field.</li>
<li>A <code v-pre>NavbarGroup</code> object should have a <code v-pre>text</code> field and a <code v-pre>children</code> field. The <code v-pre>children</code> field should be a <em>navbar array</em>, too.</li>
<li>A string should be the path to the target page file. It will be converted to a <code v-pre>NavbarItem</code> object, using the page title as <code v-pre>text</code>, and the page route path as <code v-pre>link</code>.</li>
</ul>
</li>
<li>
<p>Example 1:</p>
  ...
  theme<span class="token operator">:</span> <span class="token function">defaultTheme</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    navbar<span class="token operator">:</span> <span class="token punctuation">[</span>
      ...
      <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">]</span><span class="token punctuation">,</span>
      <span class="token punctuation">}</span><span class="token punctuation">,</span>
      <span class="token comment">// control when should the item be active</span>
      <span class="token punctuation">{</span>
        text<span class="token operator">:</span> <span class="token string">'Group 2'</span><span class="token punctuation">,</span>
        children<span class="token operator">:</span> <span class="token punctuation">[</span>
          <span class="token punctuation">{</span>
            text<span class="token operator">:</span> <span class="token string">'Always active'</span><span class="token punctuation">,</span>
            link<span class="token operator">:</span> <span class="token string">'/'</span><span class="token punctuation">,</span>
            <span class="token comment">// this item will always be active</span>
            activeMatch<span class="token operator">:</span> <span class="token string">'/'</span><span class="token punctuation">,</span>
          <span class="token punctuation">}</span><span class="token punctuation">,</span>
          <span class="token punctuation">{</span>
            text<span class="token operator">:</span> <span class="token string">'Active on /foo/'</span><span class="token punctuation">,</span>
            link<span class="token operator">:</span> <span class="token string">'/not-foo/'</span><span class="token punctuation">,</span>
            <span class="token comment">// this item will be active when current route path starts with /foo/</span>
            <span class="token comment">// regular expression is supported</span>
...
<p>Set to <code v-pre>null</code> to disable logo in dark mode. Omit this option to use <a href="#logo">logo</a> in dark mode.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  theme<span class="token operator">:</span> <span class="token function">defaultTheme</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    ...
    <span class="token comment">// You can also set it to a URL directly</span>
...
<li>
<p>Details:</p>
<p>Specify the <code v-pre>aria-label</code> attribute of the <em>select language menu</em>.</p>
...
<ul>
<li>
<p>Type: <code v-pre>false | 'auto' | SidebarConfigArray | SidebarConfigObject</code></p>
</li>
<li>
<p>Default: <code v-pre>'auto'</code></p>
</li>
...
<p>Set to <code v-pre>false</code> to disable sidebar.</p>
<p>If you set it to <code v-pre>'auto'</code>, the sidebar will be automatically generated from the page headers.</p>
<p>To configure the sidebar items manually, you can set this option to a <em>sidebar array</em>, each item of which could be a <code v-pre>SidebarItem</code> object or a string:</p>
<ul>
<li>A <code v-pre>SidebarItem</code> object should have a <code v-pre>text</code> field, could have an optional <code v-pre>link</code> field, an optional <code v-pre>children</code> field and an optional <code v-pre>collapsible</code> field. The <code v-pre>children</code> field should be a <em>sidebar array</em>. The <code v-pre>collapsible</code> field controls whether the item is collapsible.</li>
<li>A string should be the path to the target page file. It will be converted to a <code v-pre>SidebarItem</code> object, whose <code v-pre>text</code> is the page title, <code v-pre>link</code> is the page route path, and <code v-pre>children</code> is automatically generated from the page headers.</li>
</ul>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  theme<span class="token operator">:</span> <span class="token function">defaultTheme</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    <span class="token comment">// collapsible sidebar</span>
    sidebar<span class="token operator">:</span> <span class="token punctuation">{</span>
      <span class="token string-property property">'/reference/'</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">{</span>
          text<span class="token operator">:</span> <span class="token string">'VuePress Reference'</span><span class="token punctuation">,</span>
          collapsible<span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
          children<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">'/reference/cli.md'</span><span class="token punctuation">,</span> <span class="token string">'/reference/config.md'</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
        <span class="token punctuation">{</span>
          text<span class="token operator">:</span> <span class="token string">'Bundlers Reference'</span><span class="token punctuation">,</span>
          collapsible<span class="token operator">:</span> <span class="token boolean">true</span><span class="token punctuation">,</span>
          children<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">'/reference/bundler/vite.md'</span><span class="token punctuation">,</span> <span class="token string">'/reference/bundler/webpack.md'</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
      <span class="token punctuation">]</span><span class="token punctuation">,</span>
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
...
<li>
<p>Default: <code v-pre>2</code></p>
</li>
<li>
<p>Details:</p>
<p>Set the maximum depth of the sidebar children which are automatically generated from the page headers.</p>
<ul>
<li>Set to <code v-pre>0</code> to disable all levels of headers.</li>
<li>Set to <code v-pre>1</code> to include <code v-pre>&lt;h2&gt;</code> headers.</li>
<li>Set to <code v-pre>2</code> to include <code v-pre>&lt;h2&gt;</code> and <code v-pre>&lt;h3&gt;</code> headers.</li>
<li>...</li>
</ul>
<p>The max value depends on which levels of headers you have extracted via <RouterLink to="/reference/config.html#markdown-headers">markdown.headers.level</RouterLink>.</p>
<p>The default value of <code v-pre>markdown.headers.level</code> is <code v-pre>[2, 3]</code>, so the default max value of <code v-pre>sidebarDepth</code> is <code v-pre>2</code>.</p>
<p>You can override this global option via <RouterLink to="/reference/default-theme/frontmatter.html#sidebardepth">sidebarDepth</RouterLink> frontmatter in your pages.</p>
</li>
</ul>
...
<li>
<p>Default: <code v-pre>'Edit this page'</code></p>
</li>
<li>
<p>Details:</p>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The generated link will look like <code v-pre>'https://gitlab.com/owner/name/-/edit/master/docs/path/to/file.md'</code>.</p>
...
<li>
<p>Default: <code v-pre>'main'</code></p>
</li>
<li>
<p>Details:</p>
...
<p>You can override this global option via <RouterLink to="/reference/default-theme/frontmatter.html#lastupdated">lastUpdated</RouterLink> frontmatter in your pages. Notice that if you have already set this option to <code v-pre>false</code>, this feature will be disabled totally and could not be enabled in locales nor page frontmatter.</p>
</li>
</ul>
...
<li>
<p>Default: <code v-pre>'Last Updated'</code></p>
</li>
<li>
<p>Details:</p>
...
<p>You can override this global option via <RouterLink to="/reference/default-theme/frontmatter.html#contributors">contributors</RouterLink> frontmatter in your pages. Notice that if you have already set this option to <code v-pre>false</code>, this feature will be disabled totally and could not be enabled in locales nor page frontmatter.</p>
</li>
</ul>
...
<li>
<p>Default: <code v-pre>'Contributors'</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>'TIP'</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>'WARNING'</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>'DANGER'</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>['Not Found']</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>'Back to home'</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>'open in new window'</code></p>
</li>
<li>
<p>Details:</p>
<p>Specify the <code v-pre>sr-only</code> text of the <RouterLink to="/reference/plugin/external-link-icon.html#externallinkicon">ExternalLinkIcon</RouterLink>.</p>
<p>This is mainly for a11y purpose.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><a href="#themeplugins-externallinkicon">Default Theme &gt; Config Reference &gt; themePlugins.externalLinkIcon</a></li>
</ul>
</li>
</ul>
...
<li>
<p>Default: <code v-pre>'toggle color mode'</code></p>
</li>
<li>
<p>Details:</p>
...
<li>
<p>Default: <code v-pre>'toggle sidebar'</code></p>
</li>
<li>
<p>Details:</p>
...
<h2 id="plugins-config" tabindex="-1"><a class="header-anchor" href="#plugins-config" aria-hidden="true">#</a> Plugins Config</h2>
...
<h3 id="themeplugins-backtotop" tabindex="-1"><a class="header-anchor" href="#themeplugins-backtotop" aria-hidden="true">#</a> themePlugins.backToTop</h3>
<ul>
<li>
<p>Type: <code v-pre>boolean</code></p>
</li>
...
<ul>
<li>
<p>Type: <code v-pre>Record&lt;ContainerType, boolean&gt;</code></p>
</li>
<li>
<p>Details:</p>
...
<p><code v-pre>ContainerType</code> type is:</p>
<ul>
...
<li>
<p>Details:</p>
<p>Enable <RouterLink to="/reference/plugin/external-link-icon.html">@vuepress/plugin-external-link-icon</RouterLink> or not.</p>
</li>
</ul>
