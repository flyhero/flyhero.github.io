...
<NpmBadge package="@vuepress/theme-default" /><h2 id="all-pages" tabindex="-1"><a class="header-anchor" href="#all-pages" aria-hidden="true">#</a> All Pages</h2>
...
<li>
<p>Details:</p>
<p>Provided by <RouterLink to="/reference/plugin/external-link-icon.html#externallinkicon">@vuepress/plugin-external-link-icon</RouterLink>.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/default-theme/config.html#themeplugins-externallinkicon">Default Theme &gt; Config Reference &gt; themePlugins.externalLinkIcon</RouterLink></li>
</ul>
</li>
</ul>
...
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/default-theme/config.html#navbar">Default Theme &gt; Config &gt; navbar</RouterLink></li>
</ul>
</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Then you can customize styles of this page in <code v-pre>.vuepress/styles/index.scss</code> file:</p>
<div class="language-scss line-numbers-mode" data-ext="scss"><pre v-pre class="language-scss"><code><span class="token selector">.theme-container.custom-page-class </span><span class="token punctuation">{</span>
  <span class="token comment">/* page styles */</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>Also see:
<ul>
<li><RouterLink to="/reference/default-theme/styles.html#style-file">Default Theme &gt; Styles &gt; Style File</RouterLink></li>
</ul>
</li>
</ul>
<h2 id="home-page" tabindex="-1"><a class="header-anchor" href="#home-page" aria-hidden="true">#</a> Home Page</h2>
...
<p>If you don't set this frontmatter or set it to <code v-pre>false</code>, the page would be a <a href="#normal-page">normal page</a>.</p>
</li>
<li>
<p>Example:</p>
</li>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="heroimage" tabindex="-1"><a class="header-anchor" href="#heroimage" aria-hidden="true">#</a> heroImage</h3>
<ul>
<li>
<p>Type: <code v-pre>string</code></p>
</li>
...
<li>
<p>Details:</p>
<p>Specify the url of hero image to be used in dark mode.</p>
<p>You can make use of this option if you want to use different heroImage config in dark mode.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><a href="#heroimage">Default Theme &gt; Frontmatter &gt; heroImage</a></li>
<li><RouterLink to="/reference/default-theme/config.html#colormode">Default Theme &gt; Config &gt; colorMode</RouterLink></li>
</ul>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Specify the <code v-pre>alt</code> attribute of the hero image.</p>
<p>This will fallback to the <a href="#heroText">heroText</a>.</p>
</li>
</ul>
<h3 id="heroheight" tabindex="-1"><a class="header-anchor" href="#heroheight" aria-hidden="true">#</a> heroHeight</h3>
<ul>
<li>
<p>Type: <code v-pre>number</code></p>
</li>
<li>
<p>Default: <code v-pre>280</code></p>
</li>
<li>
<p>Details:</p>
<p>Specify the <code v-pre>height</code> attribute of the hero <code v-pre>&lt;img&gt;</code> tag.</p>
<p>You may need to reduce this value if the height of your hero image is less than the default value.</p>
<p>Notice that the height is also constrained by CSS. This attribute is to reduce <a href="https://web.dev/cls/" target="_blank" rel="noopener noreferrer">Cumulative Layout Shift (CLS)<ExternalLinkIcon/></a> that caused by the loading of the hero image.</p>
</li>
</ul>
...
<p>Set to <code v-pre>null</code> to disable hero text.</p>
</li>
</ul>
...
<p>Set to <code v-pre>null</code> to disable tagline.</p>
</li>
</ul>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token builtin">Array</span><span class="token operator">&lt;</span><span class="token punctuation">{</span>
...
<p>If you set it to <code v-pre>true</code>, the <a href="#footer">footer</a> will be treated as HTML code.</p>
</li>
</ul>
<h2 id="normal-page" tabindex="-1"><a class="header-anchor" href="#normal-page" aria-hidden="true">#</a> Normal Page</h2>
...
<li>
<p>Details:</p>
<p>Specify the pattern of the <em>edit this page</em> link of this page.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/default-theme/config.html#editlinkpattern">Default Theme &gt; Config &gt; editLinkPattern</RouterLink></li>
</ul>
</li>
</ul>
...
<li>
<p>Details:</p>
<p>Configure the sidebar depth of this page.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/default-theme/config.html#sidebardepth">Default Theme &gt; Config &gt; sidebarDepth</RouterLink></li>
</ul>
</li>
</ul>
...
<ul>
<li>
<p>Type: <code v-pre>NavLink | string</code></p>
</li>
<li>
<p>Details:</p>
...
<p>To configure the prev link manually, you can set this frontmatter to a <code v-pre>NavLink</code> object or a string:</p>
<ul>
<li>A <code v-pre>NavLink</code> object should have a <code v-pre>text</code> field and a <code v-pre>link</code> field.</li>
<li>A string should be the path to the target page file. It will be converted to a <code v-pre>NavLink</code> object, whose <code v-pre>text</code> is the page title, and <code v-pre>link</code> is the page route path.</li>
</ul>
</li>
<li>
<p>Example:</p>
