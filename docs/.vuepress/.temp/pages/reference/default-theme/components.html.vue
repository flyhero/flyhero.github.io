<template><div><h1 id="built-in-components" tabindex="-1"><a class="header-anchor" href="#built-in-components" aria-hidden="true">#</a> Built-in Components</h1>
<NpmBadge package="@vuepress/theme-default" /><h2 id="badge" tabindex="-1"><a class="header-anchor" href="#badge" aria-hidden="true">#</a> Badge <Badge text="badge" /></h2>
<ul>
<li>
<p>Props:</p>
<ul>
<li>type
<ul>
<li>Type: <code v-pre>'tip' | 'warning' | 'danger'</code></li>
<li>Default: <code v-pre>'tip'</code></li>
</ul>
</li>
<li>text
<ul>
...
<li>vertical
<ul>
<li>Type: <code v-pre>'top' | 'middle' | 'bottom' | undefined</code></li>
<li>Default: <code v-pre>undefined</code></li>
</ul>
</li>
</ul>
</li>
...
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token list punctuation">-</span> VuePress - <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Badge</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>tip<span class="token punctuation">"</span></span> <span class="token attr-name">text</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>v2<span class="token punctuation">"</span></span> <span class="token attr-name">vertical</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>top<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
...
<p>Use the <code v-pre>active</code> prop to set the initial active item, or the first item will be activated by default.</p>
</li>
<li>
<p>Example:</p>
</li>
...
<p><strong>Input</strong></p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>CodeGroup</span><span class="token punctuation">></span></span>
...
<div class="language-bash" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">install</span>
</code></pre></div>  </CodeGroupItem>
  <CodeGroupItem title="YARN">
<div class="language-bash" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">yarn</span> <span class="token function">install</span>
</code></pre></div>  </CodeGroupItem>
  <CodeGroupItem title="NPM" active>
<div class="language-bash" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span>
</code></pre></div>  </CodeGroupItem>
</CodeGroup>
<div class="custom-container warning"><p class="custom-container-title">WARNING</p>
<p>You must add an empty line between the starting tag of <code v-pre>&lt;CodeGroupItem&gt;</code> and the code fence, otherwise the code fence will not be parsed correctly by Markdown.</p>
<p>All content must be valid Markdown first, and then a Vue SFC.</p>
<p>Learn more: <RouterLink to="/advanced/cookbook/markdown-and-vue-sfc.html">Cookbook &gt; Markdown and Vue SFC</RouterLink></p>
