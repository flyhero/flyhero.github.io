<template><div><h1 id="command-line-interface" tabindex="-1"><a class="header-anchor" href="#command-line-interface" aria-hidden="true">#</a> Command Line Interface</h1>
<NpmBadge package="@vuepress/cli" /><p>VuePress CLI is provided by <a href="https://www.npmjs.com/package/@vuepress/cli" target="_blank" rel="noopener noreferrer">@vuepress/cli<ExternalLinkIcon/></a> package. It is included by the <a href="https://www.npmjs.com/package/vuepress" target="_blank" rel="noopener noreferrer">vuepress<ExternalLinkIcon/></a> package, and you can also install it separately.</p>
<p>Run <code v-pre>vuepress --help</code> to get following help messages:</p>
...
<p>VuePress is using <a href="https://www.npmjs.com/package/debug" target="_blank" rel="noopener noreferrer">debug<ExternalLinkIcon/></a> module.</p>
<p>Set environment variable <code v-pre>DEBUG=vuepress*</code> to enable debug logs.</p>
</div>
