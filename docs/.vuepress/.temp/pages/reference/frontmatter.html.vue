...
<NpmBadge package="@vuepress/client" /><NpmBadge package="@vuepress/markdown" /><h2 id="date" tabindex="-1"><a class="header-anchor" href="#date" aria-hidden="true">#</a> date</h2>
<ul>
<li>
...
<p>You should specify the date in the form of <code v-pre>yyyy-MM-dd</code>, or follow the <a href="https://yaml.org/type/timestamp.html" target="_blank" rel="noopener noreferrer">YAML Timestamp Type<ExternalLinkIcon/></a>.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/node-api.html#date">Node API &gt; Page Properties &gt; date</RouterLink></li>
</ul>
</li>
</ul>
...
<p>This will override the <code v-pre>description</code> option in your site config.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<li>
<p>Details:</p>
<p>Extra tags in <code v-pre>&lt;head&gt;</code> tag for the page.</p>
</li>
<li>
<p>Example:</p>
</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Rendered as:</p>
...
<p>This will override the <code v-pre>lang</code> option in your site config.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/config.html#lang">Config &gt; lang</RouterLink></li>
<li><RouterLink to="/reference/node-api.html#lang">Node API &gt; Page Properties &gt; lang</RouterLink></li>
</ul>
</li>
</ul>
...
<p>Layouts are provided by theme. If you don't specify this frontmatter, the default layout will be used. You should refer to the theme's own documentation to find what layouts it provides.</p>
<p>If the theme layouts cannot meet your needs, you can use a custom layout component.</p>
</li>
<li>
<p>Example:</p>
</li>
</ul>
<p>Register a layout component in <code v-pre>.vuepress/client.ts</code> file:</p>
...
<li><RouterLink to="/reference/node-api.html#permalink">Node API &gt; Page Properties &gt; permalink</RouterLink></li>
</ul>
</li>
</ul>
...
<p>This will override the <code v-pre>permalinkPattern</code> option in your site config.</p>
<p>This won't take effect if the <code v-pre>permalink</code> frontmatter has been set.</p>
</li>
<li>
<p>Usage:</p>
<table>
...
<p>The <code v-pre>:year</code>, <code v-pre>:month</code> and <code v-pre>:day</code> patterns are resolved according to the following priority:</p>
<ul>
<li>The <code v-pre>date</code> frontmatter.</li>
<li>The filename that matches the date pattern <code v-pre>yyyy-MM-dd-foobar.md</code> or <code v-pre>yyyy-MM-foobar.md</code>.</li>
<li>The dirname that matches the date pattern <code v-pre>yyyy/MM/dd/foobar.md</code> or <code v-pre>yyyy/MM/foobar.md</code>.</li>
<li>Fallback to <code v-pre>0000-00-00</code>.</li>
</ul>
</li>
<li>
<p>Example 1:</p>
<p>The page filename is <code v-pre>foo-bar.md</code>.</p>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Then the permalink of the page would be <code v-pre>2021/01/03/foo-bar.html</code>.</p>
<ul>
<li>
<p>Example 2:</p>
<p>The page filename is <code v-pre>2021-01-03-bar-baz.md</code>.</p>
<p>The page frontmatter is:</p>
</li>
</ul>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Then the permalink of the page would be <code v-pre>2021/01/03/bar-baz.html</code>.</p>
<ul>
<li>Also see:
<ul>
<li><RouterLink to="/reference/config.html#permalinkpattern">Config &gt; permalinkPattern</RouterLink></li>
...
<li>
<p>Details:</p>
<p>Custom data to be attached to the page route.</p>
</li>
<li>
<p>Also see:</p>
<ul>
...
<p>If you don't specify <code v-pre>title</code> in frontmatter, content of the first level-one header (i.e. <code v-pre># title</code>) will be used as the title.</p>
</li>
<li>
<p>Also see:</p>
<ul>
<li><RouterLink to="/reference/node-api.html#title">Node API &gt; Page Properties &gt; title</RouterLink></li>
</ul>
</li>
</ul>
</div></template>
