...
<NpmBadge package="@vuepress/plugin-docsearch" /><p>Integrate <a href="https://docsearch.algolia.com/" target="_blank" rel="noopener noreferrer">Algolia DocSearch<ExternalLinkIcon/></a> into VuePress, which can provide search to your documentation site.</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> @vuepress/plugin-docsearch@next
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> docsearchPlugin <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/plugin-docsearch'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="get-search-index" tabindex="-1"><a class="header-anchor" href="#get-search-index" aria-hidden="true">#</a> Get Search Index</h2>
<p>You need to <a href="https://docsearch.algolia.com/apply/" target="_blank" rel="noopener noreferrer">submit the URL of your site<ExternalLinkIcon/></a> to join the DocSearch program. The DocSearch team will send <a href="#apikey">apiKey</a> and <a href="#indexname">indexName</a> to your email once the index is generated. Then you can configure this plugin to enable DocSearch in VuePress.</p>
<p>Alternatively, you can <a href="https://docsearch.algolia.com/docs/run-your-own/" target="_blank" rel="noopener noreferrer">run your own crawler<ExternalLinkIcon/></a> to generate the index, and then use your own <a href="#appId">appId</a>, <a href="#apikey">apiKey</a> and <a href="#indexname">indexName</a> to configure this plugin.</p>
<details class="custom-container details"><summary>Official crawler config</summary>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">new</span> <span class="token class-name">Crawler</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  plugins<span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token function">docsearchPlugin</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
      appId<span class="token operator">:</span> <span class="token string">'&lt;APP_ID>'</span><span class="token punctuation">,</span>
...
<h3 id="indexbase" tabindex="-1"><a class="header-anchor" href="#indexbase" aria-hidden="true">#</a> indexBase</h3>
<ul>
<li>
<p>Type: <code v-pre>string</code></p>
</li>
<li>
<p>Default: <RouterLink to="/reference/config.html#base">base</RouterLink></p>
</li>
<li>
<p>Details:</p>
...
<p>However, if the <RouterLink to="/reference/config.html#base">base</RouterLink> of your deployments are different for different domains, you need to set the option to the <RouterLink to="/reference/config.html#base">base</RouterLink> of your <em>index domain</em>, so that other deployments could reuse the search index correctly.</p>
</li>
</ul>
<h3 id="injectstyles" tabindex="-1"><a class="header-anchor" href="#injectstyles" aria-hidden="true">#</a> injectStyles</h3>
<ul>
<li>
<p>Type: <code v-pre>boolean</code></p>
</li>
...
<h2 id="styles" tabindex="-1"><a class="header-anchor" href="#styles" aria-hidden="true">#</a> Styles</h2>
<p>You can customize styles via CSS variables that provided by <a href="https://docsearch.algolia.com/docs/styling" target="_blank" rel="noopener noreferrer">@docsearch/css<ExternalLinkIcon/></a>:</p>
