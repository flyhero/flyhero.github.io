...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> @vuepress/plugin-toc@next
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> tocPlugin <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/plugin-toc'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="differences-with-markdown-toc-syntax" tabindex="-1"><a class="header-anchor" href="#differences-with-markdown-toc-syntax" aria-hidden="true">#</a> Differences with Markdown TOC Syntax</h2>
<p>Similar to the <RouterLink to="/guide/markdown.html#table-of-contents">Table of Contents Markdown Syntax</RouterLink>, the TOC component that provided by this plugin could be used in your markdown content directly:</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token comment">&lt;!-- markdown toc syntax --></span>
[[toc]]

<span class="token comment">&lt;!-- vue toc component --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Both of them can be pre-rendered correctly in build mode. However, there are some differences between them.</p>
...
<p>This plugin could work together with <RouterLink to="/reference/plugin/active-header-links.html">@vuepress/plugin-active-header-links</RouterLink> by setting the <RouterLink to="/reference/plugin/active-header-links.html#headerlinkselector">headerLinkSelector</RouterLink> to match the <code v-pre>linkClass</code> option. When the page scroll to a certain header anchor, this corresponding link will be added <code v-pre>linkActiveClass</code> class name.</p>
...
<h2 id="component-props" tabindex="-1"><a class="header-anchor" href="#component-props" aria-hidden="true">#</a> Component Props</h2>
...
<h3 id="options-1" tabindex="-1"><a class="header-anchor" href="#options-1" aria-hidden="true">#</a> options</h3>
<ul>
<li>Type: <code v-pre>Partial&lt;TocPropsOptions&gt;</code></li>
</ul>
<div class="language-typescript line-numbers-mode" data-ext="ts"><pre v-pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">TocPropsOptions</span> <span class="token punctuation">{</span>
